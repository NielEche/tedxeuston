...
CREATE TABLE IF NOT EXISTS `items` (
  ...
  UNIQUE KEY `id` (`id`)
      ...
      CREATE TABLE IF NOT EXISTS `homepage` (
          ...
          `head` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
          `headtext` varchar(956) COLLATE utf8_unicode_ci NOT NULL,
          `head2` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
          `headtext2` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
          `section2cap` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
          PRIMARY KEY (`id`),
          UNIQUE KEY `id` (`id`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=5 ;
      ...
      CREATE TABLE IF NOT EXISTS `speakers` (
        `id` int(32) NOT NULL AUTO_INCREMENT,
        `name` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
        `occupation` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
        `event_name` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
        `event_id` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
       `instagram` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
       `linkedin` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
        `twitter` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
       `images` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
       `video_url` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
       `talk_type` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
       `talk_title` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
       `speaker_bio` varchar(999) COLLATE utf8_unicode_ci NOT NULL,
       `speaker_tags` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
      ...
      CREATE TABLE IF NOT EXISTS `gallery` (
        ...
        `images` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
        `talk_type` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
        `video_headtext` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
       `event_year` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
        `cat_id` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
       `video` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
        PRIMARY KEY (`id`),
          UNIQUE KEY `id` (`id`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=5 ;
        ...
        `id` int(32) NOT NULL AUTO_INCREMENT,
        `event_image` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
        `event_name` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
        `event_theme` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
       `event_date` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
       `about_event` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
        PRIMARY KEY (`id`),
          UNIQUE KEY `id` (`id`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=5 ;
      ...
      CREATE TABLE IF NOT EXISTS `about_ted` (
        `id` int(32) NOT NULL AUTO_INCREMENT,
        `tedabouttext` varchar(1506) COLLATE utf8_unicode_ci NOT NULL,
       `tedabouttext2` varchar(1506) COLLATE utf8_unicode_ci NOT NULL,
        PRIMARY KEY (`id`),
          UNIQUE KEY `id` (`id`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=5 ;
      ...
      CREATE TABLE IF NOT EXISTS `about_team` (
       ...
       `bio` varchar(2006) COLLATE utf8_unicode_ci NOT NULL,
        PRIMARY KEY (`id`),
          UNIQUE KEY `id` (`id`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=5 ;
      ...
      CREATE TABLE IF NOT EXISTS `tbl_album` (
          `id` int(32) NOT NULL AUTO_INCREMENT,
          `name` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
          `adesc` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
          `image` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
