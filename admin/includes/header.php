...
<html>
	...
	<head>
		...
		<meta charset="utf-8" />
		<title>TEDXEUSTON Admin Dashboard </title>
				...
				<div class="d-flex align-items-center">
					...
					<div class="dropdown pull-right d-lg-block d-none">
						...
						<span class="thumbnail-wrapper d32 circular inline">
							<img src="assets/img/tedxelogo.svg" alt="" data-src="assets/img/tedxelogo.svg" data-src-retina="assets/img/tedxelogo.svg" width="32" height="32">
						</span>
						</button>
						...
						<div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
							<form action="settings.php" method="post">
								...
								<button type="submit" name="edit_password_btn" class="btn"><a class="dropdown-item"><i class="pg-settings_small"></i> Settings</a></button>
							</form>
							<form style="margin-bottom:0;" action="logout.php" method="POST">
								
									<button type="submit" style="border-radius:0; " name="logout_btn" class="btn btn-primary clearfix bg-master-lighter dropdown-item">
